...
public class PanelPersona extends javax.swing.JPanel implements InterfacePanel {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel_crudLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_crudLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel_crudLayout.createSequentialGroup()
                        ...
                        .addComponent(jtf_buscarPersona, javax.swing.GroupLayout.PREFERRED_SIZE, 602, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel_crudLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_crudLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(jScrollPaneTabla, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addGroup(jPanel_datosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel_datosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(jPanel_datosLayout.createSequentialGroup()
                            ...
                            .addGap(10, 10, 10)
                            .addComponent(jcb_tipoPersona, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(jPanel_datosLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanel_datosLayout.createSequentialGroup()
                            ...
                            .addGap(10, 10, 10)
                            .addComponent(jtf_nombre, javax.swing.GroupLayout.PREFERRED_SIZE, 471, javax.swing.GroupLayout.PREFERRED_SIZE))))
                ...
                .addGroup(jPanel_datosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel_datosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel_datosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jlbl_alertaApellido, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addComponent(jlbl_alertaDNI, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jbtn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_modificarActionPerformed
        ...
        this.jcb_tipoPersona.setSelectedItem(this.personaSeleccionada.getUnTipoPersona());
    ...
    private void jbtn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_agregarActionPerformed
        ...
        this.jcb_tipoPersona.removeAllItems();
        habilitarTodosLosBotones(false);
        habilitarTodosLosCampos(true);
        this.validador.habilitarBoton(false, this.jbtn_listar, new Color(30, 132, 73), Color.WHITE, null, null);
        this.validador.habilitarBoton(true, this.jbtn_aceptar, new Color(30, 132, 73), Color.WHITE, null, null);
    ...
    public void habilitarTodosLosCampos(boolean estado) {
        ...
        this.validador.habilitarCombobox(estado, this.jcb_tipoPersona);
    }
    ...
    public void cargarTiposDePersona() {
        DefaultComboBoxModel mdl = new DefaultComboBoxModel(this.controlador.buscarTodosLosTiposDePersonas());
        this.jcb_tipoPersona.setModel(mdl);
    }
    ...
    public void seleccionarPersona() {
        ...
        if (filaSeleccionada >= 0) {
            ...
            this.jcb_tipoPersona.removeAllItems();
            this.jcb_tipoPersona.addItem(this.personaSeleccionada.getUnTipoPersona().getDescripcion());
        } else {
    ...
    public void agregar() {
        ...
        if ((!this.jtf_nombre.getText().isEmpty()) && (!this.jtf_apellido.getText().isEmpty()) && (!this.jtf_dni.getText().isEmpty())) {
            ...
            nuevaPersona.setUnTipoPersona((TipoPersona) this.jcb_tipoPersona.getSelectedItem());
            this.jlbl_alertaNombre.setIcon(null);
            this.jlbl_alertaApellido.setIcon(null);
            this.jlbl_alertaDNI.setIcon(null);
            this.jlbl_mensaje.setText("");
