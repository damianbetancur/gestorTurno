...
import view.resources.TablaEmpleadoProcesarTramiteModelListener;
 ...
 * @author Ariel
 */
public class PanelProcesarTramite extends javax.swing.JPanel implements InterfacePanel {
    ...
    public PanelProcesarTramite() {
        ...
        this.jtb_persona.getSelectionModel().addListSelectionListener(new TablaEmpleadoProcesarTramiteModelListener(this));
    ...
    public void cargarTiposDePersona() {
        DefaultComboBoxModel mdl = new DefaultComboBoxModel(this.controladorPersona.buscarTodosLosTiposDePersonas());
