...
public class PanelProcesarTurno05 extends javax.swing.JPanel implements InterfacePanel {
     ...
     */
    public void cargarTiposDeAtencion() {
        DefaultComboBoxModel mdl = new DefaultComboBoxModel(this.controlador.buscarTodasLosTiposDeAtencion());
        this.jcb_tipoAtencion.setModel(mdl);
    }
}
